...
##trying to create and textoutput saying this below.

#names(Masterfile) <-textOutput("WhEN Entering your unique number, remember to Push  Enter to access information", names(Masterfile)[-2])
