...
renderUI({
  ...
  basicPage(
    textInput("new_value", label = h4("Enter the new value for ", variable.choices()), placeholder = NULL),
...
renderDataTable({
  dplyr::filter(reactive_vals$data, Unique_Number == input$enter_number)
})
```
